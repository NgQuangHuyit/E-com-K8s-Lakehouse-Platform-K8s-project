...
with DAG(
    ...
    # )
    query_order = "SELECT * FROM orders where order_date = DATE('{{ ds }}');"
    
    query_order_items = "SELECT oi.* FROM order_items oi JOIN orders o ON oi.order_id = o.order_id where o.order_date = DATE('{{ ds }}');"
